...
redwines$combined.sulphur.dioxide<-redwines$total.sulfur.dioxide-redwines$free.sulfur.dioxide
redwines<-redwines[,c(1:11,13,14,12)]
lapply(1:13, function(i) HistoBox(redwines,i,comments))
...
>Data set is regarding the wine quality and several chemical componets that it contains.there ae 1599 samples of wine with 11 variables of type numeric and 1 rating factor quality of type int given by 3 wine experts according to their knowledge and experience.Quality ranges from 0 to 10 but our data has least quality of 3 and highest quality of 8. Lets find out what are the main deciding factors for high quality wine. 
